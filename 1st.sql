...
ALTER TABLE BOOK_AUTHORS
ADD CONSTRAINT FK_BOOK_AUTHORS_BOOK FOREIGN KEY (Book_id) REFERENCES BOOK(Book_id);

ALTER TABLE BOOK_COPIES
ADD CONSTRAINT FK_BOOK_COPIES_BOOK FOREIGN KEY (Book_id) REFERENCES BOOK(Book_id);

ALTER TABLE BOOK_COPIES
ADD CONSTRAINT FK_BOOK_COPIES_BRANCH FOREIGN KEY (Branch_id) REFERENCES LIBRARY_BRANCH(Branch_id);

ALTER TABLE BOOK_LENDING
ADD CONSTRAINT FK_BOOK_LENDING_BOOK FOREIGN KEY (Book_id) REFERENCES BOOK(Book_id);
